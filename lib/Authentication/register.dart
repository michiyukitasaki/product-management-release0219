 ...
 _registerUser()async{
  ...
  Future saveUserInfoToFireStore(User fUser)async{
    FirebaseFirestore.instance.collection('users').doc(fUser.uid).set({
      ...
      EcommerceApp5.signInDateTime:_formatter.format(DateTime.now())
    });
  ...
  await EcommerceApp5.sharedPreferences?.setString('uid', fUser.uid);
    ...
    await EcommerceApp5.sharedPreferences?.setString(EcommerceApp5.signInDateTime, _formatter.format(DateTime.now()));
 }
